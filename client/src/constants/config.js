...
export const SERVICE_URLS = {
  ...
  createPoll: { url: "/poll/create", method: "POST" },

  //assigned tasks
  assignTask: { url: "/task/assign", method: "POST" },
  deleteAssignedTask: {
    url: "/task/assigned/delete",
    method: "DELETE",
    query: true,
  },
  markAssignedTaskImportant: {
    url: "/task/assigned/markImportant",
    method: "PUT",
    query: true,
  },
  markAssignedTaskCompleted: {
    url: "/task/assigned/complete",
    method: "PUT",
    query: true,
  },
  getTasksforUser: { url: "/tasks/assigned/get", method: "GET", query: true },
  getAssignedByFilter: { url: "/tasks/getAssignedByFilter", method: "POST" },
};
